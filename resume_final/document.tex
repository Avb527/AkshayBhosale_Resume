...
\begin{flushleft}
	...
	\vspace{0.5mm} \\
	\begin{enumerate}
		\item Dr. Prashant Patavardhan, Head of Department, Electronics and Communication Engineering, K.L.S GIT belagavi $|$ pppatavardhan@git.edu $|$ 9448941840.
		\item Mrs. Supriya S Shanbhag, Assistant Professor, Electronics and Communication, K.L.S GIT belagavi $|$ ssshanbhag@git.edu $|$ 9845306767.
	\end{enumerate}
\end{flushleft}
\end{document}